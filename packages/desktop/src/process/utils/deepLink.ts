...
export const PROTOCOL_SCHEME = 'ideas';

/**
 * Parse an ideas:// URL into action and params.
 * Supports two formats:
 *   1. ideas://add-provider?base_url=xxx&api_key=xxx
 *   2. ideas://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
