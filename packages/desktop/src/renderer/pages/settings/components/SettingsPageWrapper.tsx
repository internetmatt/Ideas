...
export function getBuiltinSettingsNavItems(isDesktop: boolean, t: TranslateFn): NavItem[] {
  const builtinMap: Record<string, NavItem> = {
    ...
    'api-keys': {
      id: 'api-keys',
      label: t('settings.openideasApiKeys'),
      icon: <Key theme='outline' size='16' />,
      path: 'api-keys',
    },
    'document-stores': {
      id: 'document-stores',
      label: t('settings.openideasDocumentStores'),
      icon: <FolderOpen theme='outline' size='16' />,
      path: 'document-stores',
    },
    marketplaces: {
      id: 'marketplaces',
      label: t('settings.openideasMarketplaces'),
      icon: <Shop theme='outline' size='16' />,
      path: 'marketplaces',
    },
    'openideas-account': {
      id: 'openideas-account',
      label: t('settings.openideasAccount'),
      icon: <Peoples theme='outline' size='16' />,
      path: 'openideas-account',
    },
    appearance: {
      id: 'appearance',
