    ...
    <HashRouter>
      ...
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/flowise' element={withRouteFallback(FlowiseSettings)} />
          ...
          <Route path='/flowise' element={withRouteFallback(FlowisePage)} />
          <Route path='/canvas' element={<Navigate to='/flowise' replace />} />
        </Route>
